...
#image folder
#file_path = "./vgg16/validation/99.jpg" #每種器材測試5張(圖片來源不同)，測試後成功辨識率為100%；實地拍攝辨識成功率：54.84%
file_path = "material/9.png"
#dimesions of images
...
class inception_retrain(object):
    ...
    def _load_model(self):
        if self.model is None:
            self.model=load_model('./model_CnnModelTrainWorkout_v3_5calsses.h5')
...
if a == 'Dumbbell':
    print('辨識結果為：啞鈴，請參考以下教學網站：https://www.hiyd.com/dongzuo/?equipment=8')
elif a == 'Rowing boat machine':
    print('辨識結果為：划船機，請參考以下教學網站：https://www.hiyd.com/dongzuo/?equipment=34')
elif a == 'Cable crossover':
    print('辨識結果為：龍門架，請參考以下教學網站：https://www.hiyd.com/dongzuo/?equipment=32')
elif a == 'Pullback machine':
    print('辨識結果為：拉背機，請參考以下教學網站：https://www.hiyd.com/dongzuo/?equipment=35')
else:
    print('辨識結果為：槓鈴臥推機，請參考以下教學網站：https://www.hiyd.com/dongzuo/?equipment=10&muscle=9')
